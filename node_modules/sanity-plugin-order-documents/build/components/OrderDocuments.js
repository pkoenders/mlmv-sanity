...
var OrderDocuments = /*#__PURE__*/function (_React$Component) {
  ...
  function OrderDocuments() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _client["default"].fetch("*[!(_id in path(\"drafts.**\")) && _type == $types] | order (".concat(_this.state.field.value, " asc, order asc, _updatedAt desc)[").concat(length, "...").concat(length + PAGE_SIZE, "]"), {
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _client["default"].fetch("count(*[!(_id in path(\"drafts.**\")) && _type == $types])", {
                types: _this.state.type.value
              });
            ...
            case 2:
              ...
              _context2.next = 5;
              return _client["default"].fetch("*[!(_id in path(\"drafts.**\")) && _type == $types] | order (".concat(_this.state.field.value, " asc, order asc, _updatedAt desc)[0...").concat(PAGE_SIZE, "]"), {
                types: _this.state.type.value
              });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                _context4.next = 6;
                return _client["default"].fetch("*[!(_id in path(\"drafts.**\")) && _type == $types] | order (".concat(value, " asc, order asc, _updatedAt desc)[0...").concat(PAGE_SIZE, "]"), {
                  types: _this.state.type.value
                });
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "moveCard", function (beforeIndex, afterIndex) {
      var card1 = _this.state.documents[beforeIndex];
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setCardPosition", /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(OrderDocuments, [{
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement(_reactDnd.DndProvider, {
        ...
        className: _index["default"].outerWrapper
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: _index["default"].innerWrapper
        ...
        setCardPosition: this.setCardPosition,
